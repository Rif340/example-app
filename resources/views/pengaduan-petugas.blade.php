  ...
  <table class="table table-striped table-bordered" style="padding:25%;">
    ...
    <tbody>
      ...
      <td style="padding-top: 65px;">{{$pengaduan->id_pengaduan}}</td>
        ...
        <a href="/petugas-tanggapan/{{$pengaduan->id_pengaduan}}" class="btn btn-primary">tanggapi</a>
        <a href="/detail-tanggapan/{{$pengaduan->id_pengaduan}}" class="btn btn-info">detail</a>
      </tr>
      @endforeach
    </tbody>
  </table>
